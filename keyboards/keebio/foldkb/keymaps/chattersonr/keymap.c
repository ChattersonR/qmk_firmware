...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAKDH] = LAYOUT(
    ...
    KC_PGDN,          KC_LCTL, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,      LT(RAISE,KC_ENT), LT(SYMBOL,KC_BSPC), KC_RALT, RGUI_T(KC_LEFT), MT(KC_MENU,KC_DOWN), RCTL_T(KC_RIGHT)
  ),
  [_LOWER] = LAYOUT( //Nav Layer
    KC_MUTE, _______, KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,       KC_F6,      KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,
    KC_HOME,         _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     C(KC_LEFT), KC_PGDN, KC_PGUP, C(KC_RGHT), KC_PSCR, XXXXXXX, KC_PAUS, _______,
    KC_END,          _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX,     KC_LEFT,    KC_DOWN, KC_UP,   KC_RGHT,    KC_INS,  XXXXXXX,       _______,
    KC_PGUP,         _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     KC_HOME,    XXXXXXX, XXXXXXX, KC_END,     XXXXXXX, _______, _______,
  ...
  [_RAISE] = LAYOUT( //TODO. Symbol layer?
    XXXXXXX, _______,KC_GRV,  KC_F1,     KC_F2,   KC_F3,   KC_F4,   KC_F5,       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
    KC_HOME,         _______, KC_GRV,    KC_7,    KC_8,    KC_9,    KC_MINS,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    KC_END,          _______, KC_BSLS,   KC_4,    KC_5,    KC_6,    KC_EQL,      XXXXXXX, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, XXXXXXX,       _______,
    KC_PGUP,         _______, KC_LBRC,   KC_1,    KC_2,    KC_3,    KC_RBRC,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______,
    KC_PGDN,         _______, _______, _______, _______,   KC_0,    KC_0,        _______, _______, _______, _______, _______, _______
  ),
  [_SYMBOL] = LAYOUT( //TODO. Symbol layer?
    XXXXXXX,  _______, KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
    KC_HOME,         _______, KC_TILD,   KC_AMPR, KC_ASTR, KC_LPRN, KC_UNDS,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    KC_END,          _______, KC_PIPE,   KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS,     XXXXXXX, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, XXXXXXX,       _______,
    KC_PGUP,         _______, KC_LCBR,   KC_EXLM, KC_AT,   KC_HASH, KC_RCBR,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______,
    KC_PGDN,         _______, _______, _______,   KC_LPRN, KC_RPRN, KC_RPRN,     _______, _______, _______, _______, _______, _______
  ),
  //TODO put RGB brightness on encoder
  [_ADJUST] = LAYOUT(
    RGB_TOG, QK_BOOT, _______, RGB_HUD, RGB_HUI, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL,
    RGB_TOG,          _______, RGB_SAD, RGB_SAI, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, KC_7,    KC_8,    KC_9,    XXXXXXX, XXXXXXX, XXXXXXX, _______,
    RGB_MOD,          _______, RGB_VAD, RGB_VAI, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, KC_4,    KC_5,    KC_6,    XXXXXXX, XXXXXXX,          _______,
    QWERTY,           _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, KC_1,    KC_2,    KC_3,    XXXXXXX, _______, _______,
